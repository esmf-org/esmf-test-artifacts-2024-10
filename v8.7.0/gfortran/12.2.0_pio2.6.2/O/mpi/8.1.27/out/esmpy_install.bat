...
cd /glade/derecho/scratch/sacks/esmf-testing/gfortran_12.2.0_pio2.6.2_mpi_O_v8.7.0/esmf
...
python3 -m pip install . 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/gfortran_12.2.0_pio2.6.2_mpi_O_v8.7.0/esmpy-install.log
make download 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/gfortran_12.2.0_pio2.6.2_mpi_O_v8.7.0/esmpy-download.log
deactivate
conda deactivate
