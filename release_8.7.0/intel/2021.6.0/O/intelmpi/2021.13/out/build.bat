...
#SBATCH -o /discover/nobackup/projects/gmao/SIteam/ESMF_Testing/intel_2021.6.0_intelmpi_O_release_8.7.0/build.bat_%j.o
#SBATCH -e /discover/nobackup/projects/gmao/SIteam/ESMF_Testing/intel_2021.6.0_intelmpi_O_release_8.7.0/build.bat_%j.e
#SBATCH --time=1:00:00
...
module load cmake/3.30.3 comp/gcc/11.6.0
...
module list >& /discover/nobackup/projects/gmao/SIteam/ESMF_Testing/intel_2021.6.0_intelmpi_O_release_8.7.0/module-build.log
