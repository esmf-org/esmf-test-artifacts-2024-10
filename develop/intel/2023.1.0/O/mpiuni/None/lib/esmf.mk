...
ESMF_F90COMPILEPATHS=-I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/mod/modO/Unicos.intel.64.mpiuni.default -I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/src/include -I/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/include -I/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.7.0b11-6-g82f8052f9c' -DESMF_MPIUNI -I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/src/Infrastructure/stubs/mpiuni -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/tmp/intel_2023.1.0_mpiuni_O_develop/esmf
...
ESMF_F90LINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib 
ESMF_F90ESMFLINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib 
...
ESMF_CXXCOMPILEPATHS= -I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/src/include  -I/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/include -I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.7.0b11-6-g82f8052f9c' -DESMF_MPIUNI -I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/src/Infrastructure/stubs/mpiuni -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/tmp/intel_2023.1.0_mpiuni_O_develop/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib -L/opt/intel/oneapi/compiler/2023.1.0/linux/bin/intel64/../../compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib 
...
ESMF_CCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.7.0b11-6-g82f8052f9c' -DESMF_MPIUNI -I/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/src/Infrastructure/stubs/mpiuni -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/tmp/intel_2023.1.0_mpiuni_O_develop/esmf -D__SDIR__='' -DESMF_CSTD=99

ESMF_CLINKOPTS=   -qopenmp
ESMF_CLINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib -L/opt/intel/oneapi/compiler/2023.1.0/linux/bin/intel64/../../compiler/lib/intel64_lin/ -L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib 
ESMF_CESMFLINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default
ESMF_CLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib -Wl,-rpath,/opt/intel/oneapi/compiler/2023.1.0/linux/bin/intel64/../../compiler/lib/intel64_lin/ -Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_O_develop/esmf/lib/libO/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf-hdf5parallel/4.9.0.3/intel/19.0/lib
...
ESMF_INTERNAL_MPIRUN="/global/cfs/cdirs/e3sm/theurich/ESMF-Nightly-Testing/intel_2023.1.0_mpiuni_O_develop/esmf/src/Infrastructure/stubs/mpiuni/mpirun"
