...
ESMF_F90LINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_g_develop/esmf/lib/libg/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
ESMF_F90ESMFLINKPATHS=-L/tmp/intel_2023.1.0_mpiuni_g_develop/esmf/lib/libg/Unicos.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_g_develop/esmf/lib/libg/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
...
ESMF_CXXLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_g_develop/esmf/lib/libg/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
...
ESMF_CLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_g_develop/esmf/lib/libg/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib -Wl,-rpath,/opt/intel/oneapi/compiler/2023.1.0/linux/bin/intel64/../../compiler/lib/intel64_lin/ -Wl,-rpath,/tmp/intel_2023.1.0_mpiuni_g_develop/esmf/lib/libg/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib
...
ESMF_INTERNAL_MPIRUN="/gpfs/f5/nggps_emc/world-shared/Gerhard.Theurich/ESMF-Nightly-Testing-C5/intel_2023.1.0_mpiuni_g_develop/esmf/src/Infrastructure/stubs/mpiuni/mpirun"
