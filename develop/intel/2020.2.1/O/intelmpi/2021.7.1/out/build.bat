...
#SBATCH -o /work/noaa/da/mpotts/sandbox/intel_2020.2.1_intelmpi_O_develop/build.bat_%j.o
#SBATCH -e /work/noaa/da/mpotts/sandbox/intel_2020.2.1_intelmpi_O_develop/build.bat_%j.e
#SBATCH --time=1:00:00
...
module list >& /work/noaa/da/mpotts/sandbox/intel_2020.2.1_intelmpi_O_develop/module-build.log
