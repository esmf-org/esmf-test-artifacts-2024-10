...
cd /glade/derecho/scratch/sacks/esmf-testing/intel_2023.2.1_mpi_g_develop/esmf
...
cd /glade/derecho/scratch/sacks/esmf-testing/intel_2023.2.1_mpi_g_develop
...
cd /glade/derecho/scratch/sacks/esmf-testing/intel_2023.2.1_mpi_g_develop/esmf/src/addon/esmpy
python3 -m pip install . 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/intel_2023.2.1_mpi_g_develop/esmpy-install.log
make download 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/intel_2023.2.1_mpi_g_develop/esmpy-download.log
deactivate
conda deactivate
