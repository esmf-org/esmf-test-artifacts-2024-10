...
export WORK_ROOT=/discover/nobackup/projects/sbu/mpotts/esmf-test/gfortran_8.3.0_intelmpi_O_develop
export TEMP_ROOT=/discover/nobackup/projects/sbu/mpotts/esmf-test/gfortran_8.3.0_intelmpi_O_develop
cd $TEMP_ROOT/esmf
export ESMF_DIR=`pwd`
