...
#SBATCH -o /discover/nobackup/projects/gmao/SIteam/ESMF_Testing/gfortran_8.3.0_mpiuni_g_develop/build.bat_%j.o
#SBATCH -e /discover/nobackup/projects/gmao/SIteam/ESMF_Testing/gfortran_8.3.0_mpiuni_g_develop/build.bat_%j.e
#SBATCH --time=1:00:00
...
module list >& /discover/nobackup/projects/gmao/SIteam/ESMF_Testing/gfortran_8.3.0_mpiuni_g_develop/module-build.log
...
make -j 45 2>&1| tee $WORK_ROOT/build.log
