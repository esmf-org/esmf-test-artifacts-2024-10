...
#SBATCH -o /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_mpiuni_g_develop/test.bat_%j.o
#SBATCH -e /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_mpiuni_g_develop/test.bat_%j.e
#SBATCH --time=2:00:00
...
module list >& /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_mpiuni_g_develop/module-test.log
